const translations = {
  en: {
    ...
    'home.subtitle': 'The ultimate marketplace for fishing gear and equipment. Buy, sell, and bid on premium fishing products.',
    ...
    'auth.registerSuccess': 'Account created! Check your email to verify before logging in.',
    ...
    'cart.orderSuccessDesc': 'Your order has been placed. Redirecting to dashboard...',
    ...
    // Footer
    'footer.tagline': 'السوق المتكامل لمعدات الصيد. اشترِ، بع، وشارك في المزادات على أفضل الأدوات.',
  ...
  ar: {
    ...
    'home.subtitle': 'السوق المتكامل لمعدات وأدوات الصيد. اشترِ، بع، وشارك في المزادات على منتجات الصيد المتميزة.',
    ...
    'home.liveAuctionsDesc': 'شارك بالمزايدة في الوقت الفعلي على منتجات الصيد الحصرية',
    ...
    'auth.registerSuccess': 'تم إنشاء الحساب! تحقق من بريدك الإلكتروني للتحقق قبل تسجيل الدخول.',
    ...
    'verify.success': 'تم تأكيد البريد الإلكتروني بنجاح! يمكنك تسجيل الدخول الآن.',
