export const translations = {
  en: {
    ...
    "wallet.paymentNote":
      "Top-up requests are processed manually within 24 hours.",
  ...
  ar: {
    ...
    "cart.insufficientWallet":
      "رصيد المحفظة غير كافٍ. يرجى إيداع الأموال أولاً.",
    ...
    "wallet.paymentNote": "يتم معالجة طلبات الشحن يدوياً خلال 24 ساعة.",
