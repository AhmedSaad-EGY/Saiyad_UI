...
export function safeSetHTML(element, htmlString) {
  ...
  element.innerHTML = DOMPurify.sanitize(htmlString, {
      ...
      ALLOWED_ATTR: ['href','target','rel','class','id','src','alt','title','width','height','data-*','aria-*','role','type','name','value','placeholder','min','max','step','disabled','checked','selected','readonly','for','action','method','enctype','autocomplete','novalidate','colspan','rowspan','scope','headers']
  });
}
