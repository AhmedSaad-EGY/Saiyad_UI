export const translations = {
  en: {
    ...
    "auth.verificationTimeout": "Verification timed out. Please check your email and try logging in.",
    ...
    "auctions.metaDesc": "Join live fish auctions on Sayiad. Bid on fresh catches.",
    ...
    "admin.confirmApproveDesc": "This will make the product visible to all users.",
    ...
    "wallet.paymentNote": "Top-up requests are processed manually within 24 hours.",
  ...
  ar: {
    ...
    "auth.verificationTimeout": "انتهت مهلة التحقق. يرجى التحقق من بريدك الإلكتروني ومحاولة تسجيل الدخول.",
    ...
    "auctions.metaDesc": "انضم إلى مزادات الأسماك الحية على صياد. مزايدة على الصيد الطازج.",
