...
export function renderGallery(p) {
  return `<div class="col-lg-6">
    <div class="detail-image p-0 image-magnifier-wrap" id="mainImageWrap">
      ...
      <div class="rounded-circle d-flex align-items-center justify-content-center" style="position:absolute;bottom:12px;inset-inline-end:12px;background:var(--overlay);color:var(--text-inverse);width:36px;height:36px;pointer-events:none"><i class="fas fa-search-plus" aria-hidden="true"></i></div>
    </div>
  </div>`;
}
